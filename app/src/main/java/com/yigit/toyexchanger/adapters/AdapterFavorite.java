...
import static com.yigit.toyexchanger.Config.NATIVE_AD_RECIPES_LIST;
...
public class AdapterFavorite extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            ...
            if (Constant.NATIVE_AD_STYLE_RECIPE_LIST.equals("small")) {
            ...
            } else if (Constant.NATIVE_AD_STYLE_RECIPE_LIST.equals("medium")) {
                View v = LayoutInflater.from(parent.getContext()).inflate(com.solodroid.ads.sdk.R.layout.view_native_ad_news, parent, false);
                vh = new NativeAdViewHolder(v);
            } else {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof OriginalViewHolder) {
            ...
            if (p.labels.size() > 0) {
                ...
                vItem.recipeCategory.setText(arrayListCategories.get(0));
            } else {
            ...
            if (adsPref.getAdStatus() && NATIVE_AD_RECIPES_LIST) {
                vItem.loadNativeAd(context,
                        ...
                        adsPref.getApplovinMaxNativeManualId(),
                        adsPref.getApplovinDiscoveryBannerMrecZoneId(),
                        adsPref.getWortiseNativeId(),
                        sharedPref.getIsDarkTheme(),
                        false,
                        Constant.NATIVE_AD_STYLE_RECIPE_LIST,
