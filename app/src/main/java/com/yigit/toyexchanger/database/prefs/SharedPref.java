...
public class SharedPref {
    ...
    public void saveConfig(String moreAppsUrl, String redirectUrl, String privacyPolicyUrl, boolean customLabelList) {
        ...
        editor.putBoolean("custom_label_list", customLabelList);
        editor.apply();
    }
    ...
    public boolean getCustomLabelList() {
        return sharedPreferences.getBoolean("custom_label_list", false);
    }
