...
public class Constant {
    ...
    public static final int PAGER_NUMBER = 4;
    ...
    //public static final String NATIVE_AD_STYLE = "large";
    public static final String NATIVE_AD_STYLE_RECIPE_LIST = "large";
    public static final String NATIVE_AD_STYLE_RECIPE_DETAIL = "large";
    public static final String NATIVE_AD_STYLE_EXIT_DIALOG = "medium";

    public static final int MAX_RELATED_POSTS = 10;

    public static final int RECIPES_TWO_COLUMNS = 2;
    public static final int RECIPES_THREE_COLUMNS = 3;
